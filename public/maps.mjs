...
export const MAPS={
 courtyard:{id:'courtyard',name:'The Royal Courtyard',w:6200,h:4800,spawn:{x:3100,y:4200},gate:{x:3100,y:850},tint:0xffffff,difficulty:1,chartSpots:[{x:1050,y:900},{x:4350,y:950},{x:1050,y:3300},{x:4350,y:3300}],zones:[{name:'Royal Approach',x:3100,y:1350,r:820},{name:'West Memorial',x:1100,y:1600,r:700},{name:'East Watch',x:4300,y:1600,r:700},{name:'South Commons',x:3100,y:3900,r:800},{name:'Central Court',x:3100,y:2600,r:1000}]},
