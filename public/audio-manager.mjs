...
export class AudioDirector{
 ...
 async cue(id,fallback=null,options){if(this.settings.muted)return false;if(this.manifest.get(id)?.variants?.length){try{return await this.play(id,options);}catch{return false;}}return fallback?this.legacyTone(...fallback):false;}
