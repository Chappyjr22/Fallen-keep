...
export const ACHIEVEMENTS=[
 {id:'unbroken_watch',name:'Unbroken Watch',description:'Finish a run after mastering Spectral Shield and surviving 12 minutes.',metric:'sentinelUnlocked',target:1,reward:'The Sentinel'},
 {id:'lesson_in_power',name:'A Lesson in Power',description:'Finish a run after mastering Arcane Wand and defeating 750 enemies.',metric:'arcanistUnlocked',target:1,reward:'The Arcanist'},
 {id:'perfect_reaction',name:'Perfect Reaction',description:'Finish a run in which you transformed Hex Flask into Witch’s Sabbath.',metric:'alchemistUnlocked',target:1,reward:'The Alchemist'},
 {id:'light_in_dark',name:'Light in the Dark',description:'Finish a run after mastering Hallowed Censer and surviving 15 minutes.',metric:'chaplainUnlocked',target:1,reward:'The Chaplain'},
 ...
 {id:'out_of_depths',name:'Out of the Depths',description:'Break all three dungeon seals across your runs.',metric:'sealsBroken',target:3,reward:'First floor + 750 coins (one time) + The Cinder Scholar'},
 {id:'first_watch',name:'First Watch',description:'Defeat 100 enemies across your runs.',metric:'totalKills',target:100},
 {id:'hold_fast',name:'Hold Fast',description:'Survive 10 minutes in one run.',metric:'bestTime',target:600,time:true,reward:'Unlocks The Castellan'},
 {id:'ranger',name:'A Thousand Fallen',description:'Defeat 1,000 enemies in one run.',metric:'bestKills',target:1000,reward:'Unlocks The Ranger and Thornwood Bow'},
 {id:'treasury',name:'The Keep’s Treasury',description:'Earn 500 coins across your runs. Spending them does not remove progress.',metric:'earnedCoins',target:500,reward:'Unlocks The Bellkeeper'},
 {id:'last_bell',name:'The Last Bell',description:'Survive 30 minutes in the courtyard, then finish the run.',metric:'bestCourtyardTime',target:1800,time:true,reward:'Keep Key + 500 coins (one time)'}
];
